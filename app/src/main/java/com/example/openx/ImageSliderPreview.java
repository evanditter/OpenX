...
public class ImageSliderPreview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.buy_item_preview);

        ViewPager viewPager = findViewById(R.id.viewPager);
        ImageAdapterPreview adapter = new ImageAdapterPreview(this);
        ...
        alertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ImageSliderPreview.this);

                builder.setCancelable(true);
                builder.setTitle("Are you sure you want to publish this item?");
                builder.setMessage("Publishing this item will make it viewable to buyers.");
                ...
                //builder.setPositiveButton(Html.fromHtml("<font color='#8BC34A'>Yes</font>"), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(ImageSliderPreview.this, PostPublished.class));
                    }
                });
                //builder.show();
                dialog.show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.user_profile:
                startActivity(new Intent(ImageSliderPreview.this, MainProfile.class));
                return true;
            case R.id.homeButton:
                startActivity(new Intent(ImageSliderPreview.this, MainActivity.class));
            default:
